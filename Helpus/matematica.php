...
<body>
    <div id="wrapper">
        ...
        //Necessario para ordem
            ...
            <div>
                    <center><h2>Matematica</h2></center>
                </div>
              <center> <img src="img/4.png" width="500" height="300"></center> 
                <div align="justify">
...
<br>
            ...
            <div id="page-inner">
                ...
                <iframe src="chat4/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
