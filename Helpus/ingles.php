...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div>
                    <center><h2>Inglês</h2></center>
                </div>
              <center> <img src="img/11.png" width="500" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; O inglês é um idioma falado em todo mundo, de grande importância já que é a língua oficial de muitos países desenvolvidos (Estados Unidos, Inglaterra, Canadá, Austrália, etc). Saber falar inglês tornou-se praticamente obrigatório para quem quer entrar no mercado de trabalho atualmente, não se trata mais de um diferencial. A literatura inglesa (principalmente técnica - manuais, guias, etc) é utilizada em todo o mundo, até mesmo pelos países que não o tem como idioma oficial.
<br>
<br>
                </h3></justify>
            <div id="page-inner">
                ...
                <iframe src="chat11/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
