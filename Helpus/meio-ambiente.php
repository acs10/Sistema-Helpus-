...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>Área <span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            ...
            <div>
                    <center><h2>Meio Ambiente</h2></center>
                </div>
              <center> <img src="img/3.png" width="500" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; O meio ambiente, comumente chamado apenas de ambiente, envolve todas as coisas vivas e não-vivas ocorrendo na Terra, ou em alguma região dela, que afetam os ecossistemas e a vida dos humanos.
<br>
<br>
                </h3></justify>
            <div id="page-inner">
                ...
                <iframe src="chat3/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
