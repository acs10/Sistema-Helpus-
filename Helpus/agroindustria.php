...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div>
                    <center><h2>Agroindustria</h2></center>
                </div>
              <center> <img src="img/2.png" width="500" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; É integração entre campo e cidade, caracterizada pela subordinação da agricultura à indústria, pois é esta que fornece os insumos. Ao mesmo tempo, a indústria é o principal destino dos produtos agrícolas, transformando-os em alimentos, medicamentos e outros
<br>
<br>
                </h3></justify>
            <div id="page-inner">
                ...
                <iframe src="chat2/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
