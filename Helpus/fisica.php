...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div>
                    <center><h2>Fisica</h2></center>
                </div>
              <center> <img src="img/8.png" width="500" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; Física é um termo com origem no Grego “physis” que significa “natureza”. É a ciência que estuda as leis que regem os fenômenos naturais suscetíveis de serem examinados pela observação experimentação, procurando enquadrá-los em esquemas lógicos.
<br>
<br>
                </h3></justify>
            <div id="page-inner">
                ...
                <iframe src="chat8/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
