...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div>
                    <center><h2>Quimica</h2></center>
                </div>
              <center> <img src="img/9.png" width="300" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; Química é a ciência que se dedica ao estudo da matéria, levando em conta a sua composição, as reações e as transformações.
<br>
<br>
                </h3></justify>
            <div id="page-inner">
                ...
                <iframe src="chat9/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
