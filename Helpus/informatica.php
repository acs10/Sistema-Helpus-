        ...
        <div id="page-wrapper">
            <div id="page-inner">
              ...
              <center> <img src="img/1.png" width="500" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; A informática é a ciência que tem como objetivo estudar o tratamento da informação através do computador. Este conceito ou esta definição é ampla devido a que o termo informática é um campo de estudo igualmente amplo.
<br>
<br>
                </h3></justify>
               
                <iframe src="chat/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
