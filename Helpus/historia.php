        ...
        //Necessario para ordem
         ...
         <div id="page-wrapper">
            ...
            <div>
              ...
              <center> <img src="img/7.png" width="500" height="300"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; História é uma palavra com origem no antigo termo grego "historie", que significa "conhecimento através da investigação". A História é uma ciência que investiga o passado da humanidade e o seu processo de evolução, tendo como referência um lugar, uma época, um povo ou um indivíduo específico.
<br>
<br>
                </h3></justify>
            <div id="page-inner">
                ...
                <iframe src="chat7/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
