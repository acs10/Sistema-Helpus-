...
<body>
 ...
 <div id="page-wrapper">
            ...
            <div>
                    <center><h2>Geografia</h2></center>
                </div>
              <center> <img src="img/6.png" width="200" height="200"></center> 
                <div align="justify">
                   <justify> <h3>&nbsp;&nbsp;&nbsp;&nbsp; Geografia é uma ciência que que estuda o espaço humano em suas várias vertentes: física, biológica e humana.<br>
...
<br>
            ...
            <div id="page-inner">
                ...
                <iframe src="chat6/index.php" width="100%" height="650" frameborder="no" style="border: 5px solid #000000; -moz-border-radius: 10px; -webkit-border-radius: 10px;"></iframe>
